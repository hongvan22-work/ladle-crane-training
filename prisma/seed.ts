...
3. **Chính xác:** Khi rót thép vào CCM, cần định vị chính xác đến ±50mm`,
  ...
  },
  {
    ...
    summary: 'Các "ông trùm" cẩu thép toàn cầu, điểm mạnh/yếu của từng đối thủ, và chiến lược định vị cho Vinalift trong thị trường cầu trục luyện kim.',
...
## Định Vị Chiến Lược Cho Vinalift

**Vị trí mục tiêu:** "Chất lượng châu Âu, giá cạnh tranh châu Á"

| Tiêu chí | Konecranes | ZPMC | **Vinalift (mục tiêu)** |
|---------|-----------|------|------------------------|
| Chất lượng kết cấu | ★★★★★ | ★★★ | ★★★★ |
| Hệ thống điều khiển | ★★★★★ | ★★★ | ★★★★ |
| Giá cả | ★★ (đắt) | ★★★★★ (rẻ) | ★★★★ |
...
- Vinalift có lợi thế: Hiểu văn hóa châu Á, gần địa lý`,
    quizzes: [
      {
        question: 'Đâu là lợi thế cạnh tranh lớn nhất của Vinalift so với Konecranes tại thị trường Việt Nam?',
        options: [
        ...
        correctAnswer: 2,
        explanation: 'Konecranes có after-sales service mỏng tại Việt Nam và giá cao hơn 30–50%. Vinalift có thể cạnh tranh bằng dịch vụ tại chỗ nhanh chóng và giá hợp lý hơn.'
      },
      {
        question: 'Theo chiến lược đề xuất, Vinalift nên bắt đầu tấn công phân khúc nào trước?',
        options: [
        ...
        correctAnswer: 1,
        explanation: 'EAF Loading Crane ít rủi ro hơn Ladle Crane thuần túy và giúp Vinalift xây dựng kinh nghiệm thực tế, track record, và niềm tin của khách hàng trước khi tấn công phân khúc cao hơn.'
      }
    ]
  }
]
